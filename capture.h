...
#ifndef _UVCAV_CAPTURE_H_
#define _UVCAV_CAPTURE_H_
...
public:
	...
	*************************************************/
	...
	// DispatchClose():
	//
	// This is the close dispatch for the capture pin.  It closes
	// the CCapturePin object and associates it with the AVStream object
	// bagging it in the process.
	//
	static NTSTATUS 
